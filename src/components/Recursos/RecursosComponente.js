...
const objetivo1 = {
  ...
  informacion: "Cada día, más de 1 millón de personas contraen una infección de transmisión sexual (ITS)",
  ...
  descarga: "https://drive.google.com/file/d/19A7L-qm2n9XobA43J_RcOGNnUkScSPul/view"
}
...
const RecursosComponente = () => {
  ...
  return (
      <div>
        ...
        <div className="cards">
          <Card titulo={objetivo1.titulo} objetivo={objetivo1.objetivo} informacion={objetivo1.informacion} informacion2={objetivo1.informacion2} informacion3={objetivo1.informacion3} informacion4={objetivo1.informacion4} descarga={objetivo1.descarga} />
          <Card titulo={objetivo2.titulo} objetivo={objetivo2.objetivo} informacion={objetivo2.informacion} descarga={objetivo2.descarga} />
          <Card titulo={objetivo3.titulo} objetivo={objetivo3.objetivo} informacion={objetivo3.informacion} descarga={objetivo3.descarga} />
        </div>
